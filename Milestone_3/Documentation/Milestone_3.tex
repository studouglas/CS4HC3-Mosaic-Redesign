...
Once the participant starts the task the facilitator will begin to time the participant.  The facilitator will instruct the participant to 'think aloud' so that verbal record exists of their interaction with the application. The facilitator will observe and enter user behavior, user comments, and system actions.\\

After the participant has completed all tasks they will be asked to complete a questionnaire.\\

The following is a list of the Tasks the participant will complete:
\begin{itemize}
\item \textbf{Test 1.1} - Have user find course enrollment and enroll in the following courses for Winter 2015 through Mosaic, selecting lectures, tutorials, and sections so as to eliminate conflicts as needed:
\begin{itemize}
\item ANTHROP 1AA3
\item ANTRHOP 1AB3
\item COMPSCI 2DM3
\item BIOLOGY 1A03
\end{itemize}
\item \textbf{Test 1.2} - Have user find their exam schedule for the Fall 2015 semester on Mosaic 
\item \textbf{Test 1.3} - Have user find their weekly schedule for the Fall 2015 semester on Mosaic
\item \textbf{Test 2.1} -  Have user find course enrollment and enroll in the following courses using the new product selecting lectures, tutorials, and sections so as to eliminate conflicts as needed:
\begin{itemize}
\item ANTHRO 4AA3
\item ANTRHO 4M03
\item COMP SCI 1TA3
\item BIOLOGY 2AA3
\end{itemize}
\item \textbf{Test 2.2} - Have user find their exam schedule for the Fall 2015 semester using the new product
\item \textbf{Test 2.3} - Have user find their weekly schedule for the Fall 2015 semester using the new product
\end{itemize}
