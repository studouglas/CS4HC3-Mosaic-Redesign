...
\begin{itemize}
\item \textbf{Test 1.1} - Have user find course enrollment and enroll in the following courses
\begin{itemize}
\item ANTHRO 4AA3
\item ANTRHO 4M03
\item COMP SCI 1TA3
\item BIO 2AA3
\end{itemize}
\item \textbf{Test 1.2} - Have user find Exam Schedule on Mosaic 
\item \textbf{Test 1.3} - Have user find their weekly schedule on mosaic
\item \textbf{Test 2.1} -  Have user find course enrollment and enroll in a course on our website
\item \textbf{Test 2.2} - Have user find Exam Schedule with our website
\item \textbf{Test 2.3} - Have user fin their weekly schedule on our website
\end{itemize}
