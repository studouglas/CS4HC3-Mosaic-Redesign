...
It can be observed, then,  that amongst the participants tested there is qualitative and quantitative  data suggesting higher usability for the new system. The new system is found to be both easier to use and more effiecient than Mosaic.
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=\textwidth]{images/results_avg_time.png}}\\
