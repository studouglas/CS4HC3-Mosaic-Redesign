...
\begin{itemize}
\item \textbf{Test 1.1} - Have user find Exam Schedule on Mosaic 
\item \textbf{Test 1.2} - Have user find course enrollment and enroll in a course in Mosaic
\item \textbf{Test 1.3} - Have user find their weekly schedule on mosaic
\item \textbf{Test 2.1} - Have user find Exam Schedule with our website
\item \textbf{Test 2.2} -  Have user find course enrollment and enroll in a course on our website
