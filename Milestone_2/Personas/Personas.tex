...
\fbox{\includegraphics[width = 80mm , scale = 0.01, height = 70mm]{Trevor.jpg}}
\begin{center}
...
\begin{minipage}{0.5\textwidth}
\fbox{\includegraphics[width = 80mm , scale = 0.25]{Candice.jpg}}
\begin{center}
...
\begin{minipage}{0.5\textwidth}
\fbox{\includegraphics[width = 80mm, scale = 0.25]{Pablo.jpg}}
\begin{center}
